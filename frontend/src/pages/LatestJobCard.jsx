...
const LatestJobCard = ({ job }) => {
  ...
  return (
    <div  onClick={()=> navigate(`/description/${job._id}`)} className="bg-white shadow-md p-5 mx-auto border rounded-md cursor-pointer transform transition-transform hover:scale-105">
      <div>
